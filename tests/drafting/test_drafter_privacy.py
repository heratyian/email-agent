...
import email_agent.drafting.drafter as drafter_module
import email_agent.triage.triager as triager_module
...
def build_agents(tmp_path, monkeypatch):
    ...
    return EmailTriager(tmp_path, config, object()), EmailDrafter(tmp_path, config, object())
...
def test_all_dynamic_draft_input_is_redacted_and_output_is_safely_restored(tmp_path, monkeypatch):
