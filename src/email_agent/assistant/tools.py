...
def make_assistant_tools(handlers):
    ...
    def triage_messages(account_id: str, message_id: int | None = None):
        ...
        return handlers.triage(account_id, message_id=message_id)
