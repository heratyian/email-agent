...
class TriageService:
    ...
    def _retry_pending_category_syncs(self, account_id: str) -> list[TriagedEmail | TriageFailure]:
    ...
    def _triage(self, message: EmailMessage, local_id: int | None) -> TriagedEmail | TriageFailure:
        try:
